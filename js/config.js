// All wedding details live here. Edit these values and the rest of the
// site (hero, details section, envelope card, countdown) updates itself.
const WEDDING_CONFIG = {
  partner1: "Denis Kalala",
